...
pub const fn SDL_PIXELFLAG(X: i32) -> i32{(((X)>>28)&0x0F)}
pub const fn SDL_PIXELTYPE(X: i32) -> i32{(((X)>>24)&0x0F)}
pub const fn SDL_PIXELORDER(X: i32) -> i32{(((X)>>20)&0x0F)}
pub const fn SDL_PIXELLAYOUT(X: i32) -> i32{(((X)>>16)&0x0F)}
pub const fn SDL_BITSPERPIXEL(X: i32) -> i32{(((X)>>8)&0xFF)}
