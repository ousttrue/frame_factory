...
extern "C" {
    ...
    /// * index:
    pub fn SDL_GetVideoDriver(index: i32) -> *mut i8;

    /// * driver_name:
    pub fn SDL_VideoInit(driver_name: *const i8) -> i32;
    ...
    /// * displayIndex:
    pub fn SDL_GetDisplayName(displayIndex: i32) -> *mut i8;

    /// * displayIndex:
    /// * rect:
    pub fn SDL_GetDisplayBounds(displayIndex: i32, rect: *mut SDL_Rect) -> i32;

    /// * displayIndex:
    /// * rect:
    pub fn SDL_GetDisplayUsableBounds(displayIndex: i32, rect: *mut SDL_Rect) -> i32;
    ...
    /// * displayIndex:
    pub fn SDL_GetDisplayOrientation(displayIndex: i32) -> i32;
    ...
    /// * displayIndex:
    /// * mode:
    pub fn SDL_GetCurrentDisplayMode(displayIndex: i32, mode: *mut SDL_DisplayMode) -> i32;
    ...
    /// * window:
    pub fn SDL_GetWindowPixelFormat(window: *mut SDL_Window) -> u32;
    ...
    /// * window:
    pub fn SDL_GetWindowFlags(window: *mut SDL_Window) -> u32;

    /// * window:
    /// * title:
    pub fn SDL_SetWindowTitle(window: *mut SDL_Window, title: *const i8) -> c_void;

    /// * window:
    pub fn SDL_GetWindowTitle(window: *mut SDL_Window) -> *mut i8;

    /// * window:
    /// * icon:
    pub fn SDL_SetWindowIcon(window: *mut SDL_Window, icon: *mut SDL_Surface) -> c_void;
    ...
    /// * window:
    /// * name:
    pub fn SDL_GetWindowData(window: *mut SDL_Window, name: *const i8) -> *mut c_void;

    /// * window:
    /// * x:
    /// * y:
    pub fn SDL_SetWindowPosition(window: *mut SDL_Window, x: i32, y: i32) -> c_void;

    /// * window:
    /// * x:
    /// * y:
    pub fn SDL_GetWindowPosition(window: *mut SDL_Window, x: *mut i32, y: *mut i32) -> c_void;

    /// * window:
    /// * w:
    /// * h:
    pub fn SDL_SetWindowSize(window: *mut SDL_Window, w: i32, h: i32) -> c_void;

    /// * window:
    /// * w:
    /// * h:
    pub fn SDL_GetWindowSize(window: *mut SDL_Window, w: *mut i32, h: *mut i32) -> c_void;
    ...
    /// * min_w:
    /// * min_h:
    pub fn SDL_SetWindowMinimumSize(window: *mut SDL_Window, min_w: i32, min_h: i32) -> c_void;

    /// * window:
    /// * w:
    /// * h:
    pub fn SDL_GetWindowMinimumSize(window: *mut SDL_Window, w: *mut i32, h: *mut i32) -> c_void;

    /// * window:
    /// * max_w:
    /// * max_h:
    pub fn SDL_SetWindowMaximumSize(window: *mut SDL_Window, max_w: i32, max_h: i32) -> c_void;

    /// * window:
    /// * w:
    /// * h:
    pub fn SDL_GetWindowMaximumSize(window: *mut SDL_Window, w: *mut i32, h: *mut i32) -> c_void;

    /// * window:
    /// * bordered:
    pub fn SDL_SetWindowBordered(window: *mut SDL_Window, bordered: i32) -> c_void;

    /// * window:
    /// * resizable:
    pub fn SDL_SetWindowResizable(window: *mut SDL_Window, resizable: i32) -> c_void;

    /// * window:
    /// * on_top:
    pub fn SDL_SetWindowAlwaysOnTop(window: *mut SDL_Window, on_top: i32) -> c_void;

    /// * window:
    pub fn SDL_ShowWindow(window: *mut SDL_Window) -> c_void;

    /// * window:
    pub fn SDL_HideWindow(window: *mut SDL_Window) -> c_void;

    /// * window:
    pub fn SDL_RaiseWindow(window: *mut SDL_Window) -> c_void;

    /// * window:
    pub fn SDL_MaximizeWindow(window: *mut SDL_Window) -> c_void;

    /// * window:
    pub fn SDL_MinimizeWindow(window: *mut SDL_Window) -> c_void;

    /// * window:
    pub fn SDL_RestoreWindow(window: *mut SDL_Window) -> c_void;

    /// * window:
    /// * flags:
    pub fn SDL_SetWindowFullscreen(window: *mut SDL_Window, flags: u32) -> i32;

    /// * window:
    pub fn SDL_GetWindowSurface(window: *mut SDL_Window) -> *mut SDL_Surface;

    /// * window:
    pub fn SDL_UpdateWindowSurface(window: *mut SDL_Window) -> i32;
    ...
    /// * window:
    /// * grabbed:
    pub fn SDL_SetWindowGrab(window: *mut SDL_Window, grabbed: i32) -> c_void;

    /// * window:
    /// * grabbed:
    pub fn SDL_SetWindowKeyboardGrab(window: *mut SDL_Window, grabbed: i32) -> c_void;

    /// * window:
    /// * grabbed:
    pub fn SDL_SetWindowMouseGrab(window: *mut SDL_Window, grabbed: i32) -> c_void;

    /// * window:
    pub fn SDL_GetWindowGrab(window: *mut SDL_Window) -> i32;

    /// * window:
    pub fn SDL_GetWindowKeyboardGrab(window: *mut SDL_Window) -> i32;

    /// * window:
    pub fn SDL_GetWindowMouseGrab(window: *mut SDL_Window) -> i32;
    ...
    /// * window:
    /// * opacity:
    pub fn SDL_SetWindowOpacity(window: *mut SDL_Window, opacity: f32) -> i32;

    /// * window:
    /// * out_opacity:
    pub fn SDL_GetWindowOpacity(window: *mut SDL_Window, out_opacity: *mut f32) -> i32;
    ...
    /// * window:
    pub fn SDL_SetWindowInputFocus(window: *mut SDL_Window) -> i32;
    ...
    pub fn SDL_SetWindowHitTest(
        window: *mut SDL_Window,
        callback: extern "C" fn(*mut SDL_Window, *mut SDL_Point, *mut c_void) -> i32,
        callback_data: *mut c_void,
    ) -> i32;

    /// * window:
    /// * flash_count:
    pub fn SDL_FlashWindow(window: *mut SDL_Window, flash_count: u32) -> i32;

    /// * window:
    pub fn SDL_DestroyWindow(window: *mut SDL_Window) -> c_void;
    ...
    /// * path:
    pub fn SDL_GL_LoadLibrary(path: *const i8) -> i32;

    /// * proc:
    pub fn SDL_GL_GetProcAddress(proc: *const i8) -> *mut c_void;

    pub fn SDL_GL_UnloadLibrary() -> c_void;

    /// * extension:
    pub fn SDL_GL_ExtensionSupported(extension: *const i8) -> i32;

    pub fn SDL_GL_ResetAttributes() -> c_void;

    /// * attr:
    /// * value:
    pub fn SDL_GL_SetAttribute(attr: i32, value: i32) -> i32;

    /// * attr:
    /// * value:
    pub fn SDL_GL_GetAttribute(attr: i32, value: *mut i32) -> i32;
    ...
    /// * window:
    /// * context:
    pub fn SDL_GL_MakeCurrent(window: *mut SDL_Window, context: *mut c_void) -> i32;
    ...
    /// * w:
    /// * h:
    pub fn SDL_GL_GetDrawableSize(window: *mut SDL_Window, w: *mut i32, h: *mut i32) -> c_void;
    ...
    /// * window:
    pub fn SDL_GL_SwapWindow(window: *mut SDL_Window) -> c_void;

    /// * context:
    pub fn SDL_GL_DeleteContext(context: *mut c_void) -> c_void;
}
